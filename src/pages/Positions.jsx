      ...
      <table className="min-w-full border-collapse">
        <thead>
          <tr className="bg-gray-100">
            ...
            <th className="px-4 py-2 text-left font-bold">Ticket</th>
            ...
            <th className="px-4 py-2 text-left font-bold">Price (open)</th>
            <th className="px-4 py-2 text-left font-bold">SL</th>
            <th className="px-4 py-2 text-left font-bold">TP</th>
